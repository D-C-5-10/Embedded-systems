 ...
 *
 * <Given an array of  if the length is even it will calculate
 ...
 * @param <lengh> <number of items inside the corresponding array>
 *
 * @return <unsigned char variable containing the median>
 */
 ...
 *
 * <Given an array this function sorts it from large to small and returns the first item  >
 *
 * @param <Array> <the unsigned char array which we will print >
 * @param <lengh> <number of items inside the corresponding array>
 * 
 ...
 *
 * <Given an array this function sorts it and  returns the last item  >
 *
 * @param <Array> <the unsigned char array which we will print >
 * @param <lengh> <number of items inside the corresponding array>
 * 
 ...
 *
 * <Given an array of data and the lengh this function will compare each item with all the others and
  sort them from large to small >
 *
 * @param <Array> <the unsigned char array which we will print >
 * @param <lengh> <number of items inside the corresponding array>
 * 
 * @return <No return from this function as we will be changing the inputed array>
 */
